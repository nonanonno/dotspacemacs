...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (add-hook 'c++-mode-hook (lambda () (add-hook 'before-save-hook (lambda() (clang-format-buffer)) nil 'local)))
  (add-hook 'cuda-mode-hook (lambda () (add-hook 'before-save-hook (lambda() (clang-format-buffer)) nil 'local)))
  (add-hook 'd-mode-hook 'company-mode)
